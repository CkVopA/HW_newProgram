...
public class Main {
        ...
        Figure tr1 = new Triangle(3,5,7);
        Figure sq1 = new Square(5);
        Figure re1 = new Rectangle(2, 6);
        Figure ci1 = new Circle(5);
        System.out.println("----------------------------------------");
...
//        Shape ci2 = new Circle(-9);
        ...
        Figure[] arrFigure = {tr1, sq1, re1, ci1};
        for (Figure s: arrFigure) {
            s.calculatePerimeterFigure();
            s.calculateAreaFigure();
        }
    }
}